...
public class Banner {
    public static void main(String[] args) {
        ...
        persons[2] = new Staff("Jim Brown", "700000000", "789 boulevard, city, state, zip, usa", "jbrown@samford.edu");
        persons[3] = new Student("Alice Johnson", "900000001", "321 road, city, state, zip, usa", "ajohnson@samford.edu");
        persons[4] = new Faculty("Bob Williams", "800000001", "654 lane, city, state, zip, usa", "bwilliams@samford.edu");
